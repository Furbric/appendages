...
public class OutfitManager {
	...
	public static Outfit getOutfitFor(PlayerEntity player) {
		...
		AppendageType funkyType = new AppendageType().setId(new Identifier(Init.MODID, "test_type"));
		...
		Appendage breadArms = new Appendage()
			.setType(funkyType)
		...
		Appendage breadEars = new Appendage()
			.setType(funkyType)
		...
		test.addAppendage(new Appendage()
			.setType(funkyType)
